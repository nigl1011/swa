...
public List<Artikel> findArtikelByKategorieAndFarbe(KategorieType kategorie, String farbe) {
if (Strings.isNullOrEmpty(farbe)) {
final List<Artikel> artikel = findVerfuegbareArtikel();
return artikel;
}

final List<Artikel> artikel = em.createNamedQuery(Artikel.FIND_ARTIKEL_BY_KAT_AND_FAR, Artikel.class)
.setParameter(Artikel.PARAM_KATEGORIE, "%" + kategorie + "%")
